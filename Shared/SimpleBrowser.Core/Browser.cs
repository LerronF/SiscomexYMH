...
namespace SimpleBrowser.Core
{
    ...
    using SimpleBrowser.Core.Internal;
    using SimpleBrowser.Core.Network;
    using SimpleBrowser.Core.Parser;
    using SimpleBrowser.Core.Query;
